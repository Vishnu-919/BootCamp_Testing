...
public class VitaminsLaunch {
	@Test
    public void TestDemo() throws Exception {
        WebDriver driver = new ChromeDriver();
        driver.manage().window().maximize();
        driver.navigate().to("https://hollandandbarrett.com/shop/vitamins-supplements/vitamins/");
        ...
        driver.quit(); // Added to safely close the browser after execution
    }
